 ...
 * <span class="changed_modified_2_0_rev_a">Foundation</span> class for <code>FaceletHandler</code>s associated with a markup element in a Facelet document.
 * This class introduces the concept of <a href="TagAttribute.html">XML attributes</a> to Facelets. See the
 * <a href="#TagHandler(jakarta.faces.view.facelets.TagConfig)">constructor</a> documentation for more details.
 * </p>
 *
 *
 * @since 2.0
...
public abstract class TagHandler implements FaceletHandler {
    ...
    /**
     * <p class="changed_added_2_0_rev_a">
     * A reference to the <code>FaceletHandler</code> that represents the first nested child of this <code>TagHandler</code> instance.
     * </p>
     */
    ...
    /**
     * <p class="changed_added_2_0">
     * Every <code>TagHandler</code> instance is associated with a {@link Tag}. Each <code>Tag</code> instance has a {@link TagAttributes} property, which is
     * simply a collection of {@link TagAttribute} instances. Extract and save as protected instance variables the {@link TagConfig#getTagId},
     * {@link TagConfig#getTag} and {@link TagConfig#getNextHandler} returns from the argument <code>TagConfig</code>. This constructor is only called when the
     * Facelets View is compiled.
     * </p>
     *
