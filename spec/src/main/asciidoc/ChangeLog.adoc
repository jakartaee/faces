:issue_tracker_url: https://github.com/eclipse-ee4j/faces-api/issues/
...
working withJakarta Server Pagesas well (kind of like f:validateRegex), as can be seen
from theJakarta Server PagesTLDDocs.
...
suppose we could mention this tidbit in theJakarta Server Pagessection."

Dan is correct that it should be mentoned in
theJakarta Server Pagessection, but also, that f:validateBean and f:validateRequired
...
to be removed from theJakarta Server PagesPDL documentation
|yes |
