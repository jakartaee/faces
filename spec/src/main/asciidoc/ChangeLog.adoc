...
===== Availability of f:validateBean and f:validateRequired in Jakarta Server Pages
...
from the Jakarta Server Pages TLDDocs.
...
suppose we could mention this tidbit in the Jakarta Server Pages section."
