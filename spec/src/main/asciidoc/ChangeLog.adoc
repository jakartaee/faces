...
EnumConverter now auto-discovers type
...
Resolve _#{cc}_/_#{component}_ via EL instead of CDI; clarify _request_, _session_, _application_ EL resolution
...
Remove deprecated cc:extension and custom scope events
