...
Pass through attributes may be specified on _<f:facet>_ tags using any of
the three methods described above. When pass through attributes are declared
on a facet, the following behavior applies:
