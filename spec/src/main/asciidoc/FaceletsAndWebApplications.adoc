...
As of version 2 of JavaServer Faces,
Jakarta Server Faces implementations must support (although JSF-based
...
the supplied tag libraries declared in <<FaceletsAndWebApplications.adoc#a5691,See
...
jazkarta.faces.validator.BeanValidator, configure its properties based on
