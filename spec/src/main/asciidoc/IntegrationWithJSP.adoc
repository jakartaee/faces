...
{empty} [maxFractionDigits=”_maxFractionDigits_”]

{empty} [maxIntegerDigits=”_maxIntegerDigits_”]

{empty} [minFractionDigits=”_minFractionDigits_”]

{empty} [minIntegerDigits=”_minIntegerDigits_”]
...
itemValue=”_itemValue_”

itemLabel=”_itemLabel_”

[itemDescription=”_itemDescription_”] />
...
|===
a|
<f:subview id=”_componentIdOrImmediateExpression_”
