...
<<Footnotes.adoc#a9099,[10]>> [[a9099]]Nest the multiple
components inside a _<h:panelGroup>_ tag that is the value of the
facet if you need control over the component type, the renderer
type or the client identifier of the container component.
