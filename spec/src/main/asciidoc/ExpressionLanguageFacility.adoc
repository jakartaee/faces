...
A query string carried by _property_, introduced by a ’ _?_ ’ character,
is not considered when counting the colon characters below. It is part of
the _resourceName_ passed to __ResourceHandler.createResource()__.
