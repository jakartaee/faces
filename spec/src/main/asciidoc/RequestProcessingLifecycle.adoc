...
to the resource metadata in the value returned by
__Resource.getRequestPath()__. It must not use any of the parameter names
that the run-time itself uses there, being ’ _ln_ ’, ’ _loc_ ’
and ’ _con_ ’.
